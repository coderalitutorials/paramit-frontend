...
import toast, { Toaster } from "react-hot-toast"; // <-- 1. Toaster yahan import kiya
...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // 2. Loading Toast trigger (Jaise contact us page par kiya tha)
    const loaderToast = toast.loading("Submitting your call back request...", {
      style: {
        fontFamily: "sans-serif",
        fontSize: "15px",
        background: "#131452",
    ...
    try {
      const response = await axios.post("https://paramit-backend.vercel.app/api/callback", formData);
  ...
  return (
    <main className="overflow-hidden bg-white">
      {/* 3. Toaster container yahan add kiya takay notification screen par show ho sake */}
